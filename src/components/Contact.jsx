function Component() {
  return (
    <div className="contact-container flex flex-col w-full bg-gray-800 py-14 px-4">
      <div className="title-contact-wrapper flex flex-col items-center gap-5 text-center mb-12">
      ...
      <form action="" className="formulaire-contact flex flex-col gap-8 mb-20">
        <input
          type="text"
      ...
      <div className="social-contact-wrapper flex flex-col gap-5 items-center">
