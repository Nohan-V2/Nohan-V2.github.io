function Component() {
  return (
    <div className="contact-container flex flex-col bg-gray-800 w-full py-16">
      <div className="contact-container-wrapper flex flex-col items-center text-center w-[344px] md:flex-row">
        <div className="title-contact-wrapper flex flex-col gap-5 text-center mb-12 min-w-[344px] max-w-[1110px] md:text-left">
        ...
        <form
          action=""
          className="formulaire-contact flex flex-col gap-8 mb-20 min-w-[344px] max-w-[1110px]"
        >
          <input
            type="text"
      ...
      <div className="social-contact-wrapper flex flex-col items-center gap-5 min-w-[344px] max-w-[1110px]">
