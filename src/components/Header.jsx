...
function Header() {
  return (
    <header className="header-container flex flex-col items-center gap-5 pt-5 px-4 w-11/12 max-w-[1440px] md:flex-row md:justify-between md:px-8 lg:px-0 lg:pt-10">
